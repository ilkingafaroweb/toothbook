...
export const Metrics: React.FC<MetricsProps> = ({ heading ,metrics }) => {
    return (
        <div className='flex flex-col items-center space-y-16 lg:px-8 py-24'>
            ...
            <div className='w-full bg-lightGray p-16 flex lg:flex-row flex-col items-center text-center justify-between lg:space-x-8 lg:space-y-0 space-y-8 rounded-2xl'>
